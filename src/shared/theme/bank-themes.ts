...
export const BANK_THEME_TILES: ReadonlyArray<{ id: string; label: string; bg: string }> = [
  ...
  { id: "oceano", label: "Oceano", bg: "linear-gradient(135deg,#2C9CD6,#15567E)" },
  { id: "carmim", label: "Carmim", bg: "linear-gradient(135deg,#E0506B,#8E1F32)" },
  { id: "dourado", label: "Dourado", bg: "linear-gradient(135deg,#C9A24B,#7A5A14)" },
